...
public class ParkSwitchView extends View implements View.OnClickListener {
    ...
    public ParkSwitchView(Context context) {
        this(context, null);
    }

    public ParkSwitchView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ParkSwitchView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void setAnimView(ObjectAnimator anim, Object... values) {
        ...
        anim.setEvaluator(new ParkColorEvaluator());
    }
    ...
    public void setOnClickCheckedListener(ParkSwitchView.onClickCheckedListener onClickCheckedListener) {
