...
import com.wisdplat.hmi.objects.Road
...
abstract class BaseRenderer(private val context: Context) : GLSurfaceView.Renderer {
    ...
    lateinit var textureShaderProgram1: TextureShaderProgram
    //非纹理着色器程序
...
//        }
    ...
    open fun addTextureModel(model:BaseTextureModel) {
    ...
    open fun moveTextureModel(model: BaseTextureModel) {
        if (modelMap.containsKey(model.id)) {
    ...
    fun drawTextureModel(model: BaseTextureModel) {
        ...
        // positionCarInScene(model as Car)
...
//     //  rotateM(modelMatrix, 0, -3f, 0f, 0f, 1f)
       rotateM(modelMatrix, 0, -94f, 1f, 0f, 0f)
...
//        }
    ...
    fun positionObjectInScene(model: Line) {
        Matrix.setIdentityM(modelMatrix, 0)
      //  Matrix.rotateM(modelMatrix, 0, -94f, 1f, 0f, 0f)
    ...
    fun positionObjectInScene1(model: Road) {
        Matrix.setIdentityM(modelMatrix, 0)
        // rotateM(modelMatrix, 0, -3f, 0f, 0f, 1f)
        Matrix.rotateM(modelMatrix, 0, -90f, 2f, 0f, 0f)
        Matrix.translateM(modelMatrix, 0,model.position.x, model.position.y, model.position.z)
